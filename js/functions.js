  ...
  $(document).ready(function ($) {
    ...
    if ($(".event-section").length) {
      $(".event-section").each(function () {
        ...
        var myVal = $(this).data("value");
        $this.appear(function () {
          $(".event-section .event-block .event-box").addClass(
    ...
    if ($(".video-testimonial-section").length) {
      $(".video-testimonial-section").each(function () {
        ...
        var myVal = $(this).data("value");
        $this.appear(function () {
          $(".video-testimonial-section .video-block").addClass(
            "animated fadeInLeft"
          );
          $(".video-testimonial-section .testimonial-block").addClass(
            "animated fadeInRight"
          );
        });
      });
    ...
    if ($(".coursesdetail-section").length) {
      $(".coursesdetail-section").each(function () {
        ...
        var myVal = $(this).data("value");
        $this.appear(function () {
          $(".coursesdetail-section .event-contentarea").addClass(
            "animated fadeInLeft"
          );
          $(".coursesdetail-section .event-sidebar").addClass(
            "animated fadeInRight"
          );
        });
      });
    ...
    if ($(".whychooseus-section").length) {
      $(".whychooseus-section").each(function () {
        ...
        var myVal = $(this).data("value");
        $this.appear(function () {
          $(".whychooseus-section .video-block").addClass(
            "animated fadeInLeft"
          );
          $(".whychooseus-section .accordion-section").addClass(
            "animated fadeInRight"
          );
        });
      });
    ...
    if ($(".contactus-section").length) {
      $(".contactus-section").each(function () {
        ...
        var myVal = $(this).data("value");
        $this.appear(function () {
          $(".contactus-section .row .map").addClass(
            "animated rotateInDownLeft"
          );
          $(".contactus-section .row .getintouch").addClass(
            "animated rotateInUpLeft"
          );
          $(".contactus-section .contactdetail-block").addClass(
